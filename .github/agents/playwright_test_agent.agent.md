---
name: playwright_test_agent
description: This custom agent generates Playwright tests for various pages and actions.
argument-hint: Use @prompts/playwright-test-template.md to generate a test. Answer the clarifying questions to fill in the template.
model: GPT-4.1
tools: [execute, read, edit, search, web, agent, todo] # specify
